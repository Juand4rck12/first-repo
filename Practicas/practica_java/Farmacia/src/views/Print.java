...
public class Print extends javax.swing.JFrame {
    ...
    public void listAllPurchasesDetails(int id) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            row[5] = list.get(i).getPurchaser(); // Comprador
    ...
    private void initComponents() {
        ...
        form_print.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 450, -1, -1));
        form_print.add(txt_total, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 450, 120, 30));
        ...
        getContentPane().add(btn_print_purchase, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 540, 150, -1));
